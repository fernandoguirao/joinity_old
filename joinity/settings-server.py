...
if LOCALHOST:
    STATIC_ROOT = '/Users/girien/Documents/Bueninvento/joinity/static/'
else:
...
if LOCALHOST:
    STATICFILES_DIRS = (
        ...
        '/Users/girien/Documents/Bueninvento/joinity/static-files/',
    )
else:
    STATICFILES_DIRS = (
        # Put strings here, like "/home/html/static" or "C:/www/django/static".
        # Always use forward slashes, even on Windows.
        # Don't forget to use absolute paths, not relative paths.
        '/var/www/vhosts/bueninvento.net/proyectos/django/prueba1/static-files/',
    )
