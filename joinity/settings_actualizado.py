...
MANAGERS = ADMINS
if LOCALHOST:
    ROOT='/Users/girien/Documents/Bueninvento/joinity'
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.mysql',  # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
            'NAME': 'joinity',  #joinity Or path to database file if using sqlite3.
            # The following settings are not used with sqlite3:
            #'USER': 'joinity_branch',
            'USER': 'joinity',
            #'PASSWORD': 'R1ch4rdSt4llm4n',
            'PASSWORD': 'C4s10p34',
    ...
    ROOT='/var/www/vhosts/bueninvento.net/proyectos/django/prueba1'
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.mysql',  # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
...
PAYPAL_RECEIVER_EMAIL='joinity@joinity.com'

SITE_NAME = 'http://joinity.net'
